...
{
    int x1 = max(rect1._x, rect2._x);
    int x2 = min(rect1._x + rect1._w, rect2._x + rect2._w);
    int y1 = max(rect1._y, rect2._y);
    int y2 = min(rect1._y + rect1._h, rect2._y + rect2._h);
...
{
    int x1 = min(rect1._x, rect2._x);
    int x2 = max(rect1._x + rect1._w, rect2._x + rect2._w);
    int y1 = min(rect1._y, rect2._y);
    int y2 = max(rect1._y + rect1._h, rect2._y + rect2._h);
